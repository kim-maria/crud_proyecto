    ...
    <section id="navbar">
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top has-background-success" aria-label="Thirteenth navbar example">
            <div class="container-fluid ">
                ...
                <a class="nav-link active text-white col-lg-2 me-0 fs-5" href="<?php echo APP_URL; ?>apoderado/">Creciendo Juntos</a>
                ...
                <div class="offcanvas offcanvas-end text-bg-dark" style="width: 270px;" tabindex="-1" id="offcanvasNavbar"
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav mx-auto text-center">
                            <li class="nav-item">
                                <a class="nav-link active fs-5 px-4" aria-current="page" href="#Inicio">Inicio</a>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item fs-5" href="#Cuid_niños">Cuidado de Niños</a></li>
                                    <li>
                                        <hr class="dropdown-divider">
                                    </li>
                                    <li><a class="dropdown-item fs-5" href="#Cuid_niños">Estimulación Temprana</a></li>
                                    <li>
                                        <hr class="dropdown-divider">
                                    </li>
                                    <li><a class="dropdown-item fs-5" href="#Cuid_niños">Atención Personalizada</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active fs-5 px-4" aria-current="page" href="#Contactanos">Contáctanos</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active fs-5 px-4" aria-current="page" href="#Nosotros">Nosotros</a>
                            </li>
                        </ul>
