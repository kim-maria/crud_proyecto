            ...
            <div class="columns">
                <div class="column">
                    <div class="control">
                        ...
                        <input class="input" type="text" name="usuario_telefono" pattern="^[9][0-9]{8}$" maxlength="9" value="<?php echo $datos['usuario_telefono']; ?>" required>
                        <p class="help">Ingrese un número de teléfono que comience con 9 y tenga 9 dígitos.</p>
                    </div>
                </div>
                <div class="column">
                    <div class="control">
                        ...
                        <div class="select">
                            <div>
                                <select name="usuario_tipoUsuario" required>
                                    <option value="">Seleccione un rol</option>

                                    <option value="Profesor" <?php echo ($datos['usuario_tipoUsuario'] == 'Profesor') ? 'selected' : ''; ?>>Profesor</option>
                                    <option value="Padre" <?php echo ($datos['usuario_tipoUsuario'] == 'Padre') ? 'selected' : ''; ?>>Padre</option>
                                </select>
                            </div>
